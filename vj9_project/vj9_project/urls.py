...
urlpatterns = [
    ...
    path('upisprofesor/<int:student_id>/<int:predmet_id>/', views.upisprofesor, name='upisprofesor'),
    path('polozenpredmet/<int:student_id>/<int:predmet_id>/', views.polozenpredmet, name='polozenpredmet'),
    path('izgubiopravo/<int:student_id>/<int:predmet_id>/', views.izgubiopravo, name='izgubiopravo'),
]
